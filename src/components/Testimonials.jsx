  ...
  return (
    <section id="testimonial" className="bg-white py-[70px] lg:py-[100px]">
      <div className="inner text-center">
        <h2 className="text-[34px] font-semibold leading-[37px] text-[#1B1B1B] sm:text-[40px] sm:leading-[43px] lg:text-[45px] lg:leading-[49px]">
          ...
          {testimonials.map((item, index) => (
            ...
            >
              <div className="relative mx-auto h-[124px] w-[124px] sm:h-[148px] sm:w-[148px]">
                ...
                />
                <span
                  className={`absolute left-[-14px] top-[20px] grid h-[43px] w-[43px] place-items-center rounded-full ${index === 1 ? "bg-cw-dark" : "bg-cw-dark"} ${active === index ? "bg-cw-green" : ""} text-white transition duration-300 group-hover:bg-white group-hover:text-cw-green`}
                >
                  <AssetIcon
